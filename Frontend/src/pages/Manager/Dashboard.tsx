...
const Dashboard = () => {
  ...
  useEffect(() => {
    ...
    const fetchStats = async () => {
      try {
        const statsResponse = await axios.get("http://localhost:5000/manager/dashboard/stats");
        setStats(statsResponse.data);

        const reservationsResponse = await axios.get("http://localhost:5000/manager/dashboard/upcoming-reservations");
