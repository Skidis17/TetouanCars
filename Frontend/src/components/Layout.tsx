...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    { name: 'Tableau de Bord', path: '/manager/dashboard', icon: <LayoutDashboard className="h-5 w-5" /> },
    { name: 'Réservations', path: '/manager/reservations', icon: <ClipboardList className="h-5 w-5" /> },
    { name: 'Calendrier', path: '/manager/calendar', icon: <Calendar className="h-5 w-5" /> },
    { name: 'Liste des Clients', path: '/manager/clients', icon: <User className="h-5 w-5" /> }, 
    { name: 'Liste des voitures', path: '/manager/carsList', icon: <Car className="h-5 w-5" /> }, 
    { name: 'Historique Réservations', path: '/manager/reservations-history', icon: <History className="h-5 w-5" /> },
